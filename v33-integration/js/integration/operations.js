(function(){
  ...
  function pollModel(activePoll={},votes=[]){
  ...
  function datedSubstituteMode(config={},date=new Date()){
    ...
    return Object.freeze({dateKey,active:config?.active===true&&sameDay&&notExpired,reason:text(config?.reason,'Ask your substitute teacher if you need help or need to leave the room.'),expiresAtMs});
  }
