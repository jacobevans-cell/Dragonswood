...
assert.match(rootTeacher,/js\/teacher-app\.js\?v=58\.1\.5/,'live Teacher Command must cache-bust the daily gradebook app');
...
assert.match(app,/gradeIntegrityVersion!==5\|\|gradebook\.reportCardPercentageReady!==true/,'CSV percentage export must remain V5 grade-integrity gated');
...
console.log('V58.1.0 daily gradebook cards with current and recovery evidence: PASS');
