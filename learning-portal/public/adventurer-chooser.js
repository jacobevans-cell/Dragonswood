...
import {actorPalette} from './battle-actors/actor-selection.js?v=dragon-path-11';
import {ADVENTURER_SETUP_VERSION,APPEARANCE_OPTIONS,setupHero} from './adventurer-setup.js?v=dragon-path-11';
