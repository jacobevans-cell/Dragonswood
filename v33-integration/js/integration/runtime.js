(function(){
  ...
  async function startStudent(onUpdate){
    ...
    const {S,auth,db}=F;
    let profileUnsub=null,dailyUnsub=null,overrideUnsub=null,scribeUnsub=null,responsesUnsub=null,gamesUnsub=null,scheduleUnsub=null,jobsUnsub=null,eventsUnsub=null,jobWeekUnsub=null,scoresUnsub=null,rewardsUnsub=null,lootUnsub=null,prizesUnsub=null,pollUnsub=null,pollVotesUnsub=null;
    ...
    let lastProfile=null,lastDaily=[],lastOverride={},lastScribe={},lastResponses=[],lastGames=[],lastSchedule={},lastJobs={},lastEvents=[],lastJobWeek=null,lastScores=[],lastRewards=[],lastLoot=[],lastPrizes=[],lastPoll={},lastPollVotes=[],currentUser=null,testerAuthorized=false;
    let lastPassStatuses={},lastPassRequests={},lastBathroomSlots={},lastPassBlackout={};
    const ready={profile:false,daily:false,override:false,scribe:false,responses:false,games:false,schedule:false,jobs:false,events:false,jobWeek:false,scores:false,rewards:false,loot:false,prizes:false,poll:false,pollVotes:false,bathroomStatus:false,snackStatus:false,outOfSeatStatus:false,officeStatus:false,bathroomRequest:false,snackRequest:false,outOfSeatRequest:false,officeRequest:false,boySlot:false,girlSlot:false,passBlackout:false};
    const clear=()=>{
      for(const fn of [profileUnsub,dailyUnsub,overrideUnsub,scribeUnsub,responsesUnsub,gamesUnsub,scheduleUnsub,jobsUnsub,eventsUnsub,jobWeekUnsub,scoresUnsub,rewardsUnsub,lootUnsub,prizesUnsub,pollUnsub,pollVotesUnsub,bathroomStatusUnsub,snackStatusUnsub,outOfSeatStatusUnsub,officeStatusUnsub,bathroomRequestUnsub,snackRequestUnsub,outOfSeatRequestUnsub,officeRequestUnsub,boySlotUnsub,girlSlotUnsub,blackoutUnsub])try{fn?.()}catch{}
      profileUnsub=dailyUnsub=overrideUnsub=scribeUnsub=responsesUnsub=gamesUnsub=scheduleUnsub=jobsUnsub=eventsUnsub=jobWeekUnsub=scoresUnsub=rewardsUnsub=lootUnsub=prizesUnsub=pollUnsub=pollVotesUnsub=null;
      ...
      lastProfile=null;lastDaily=[];lastOverride={};lastScribe={};lastResponses=[];lastGames=[];lastSchedule={};lastJobs={};lastEvents=[];lastJobWeek=null;lastScores=[];lastRewards=[];lastLoot=[];lastPrizes=[];lastPoll={};lastPollVotes=[];
  ...
  async function startTeacher(onUpdate){
    ...
    const authUnsub=S.auth.onAuthStateChanged(auth,user=>{
      ...
      [['students','roster'],['dailyQuestProgress','daily'],['curriculumAttempts','curriculum'],['writingResponses','responses'],['gameResults','games'],['bathroomRequests','bathroomRequests'],['snackRequests','snackRequests'],['passRequests','passRequests'],['pointRequests','pointRequests'],['bathroomStatus','bathroomStatus'],['snackStatus','snackStatus'],['passStatus','passStatus'],['passHistory','passHistory'],['bathroomSlots','bathroomSlots'],['curriculumOverrideRequests','curriculumOverrides'],['classPollVotes','pollVotes'],['studentJobWeeks','jobWeeks'],['classCalendarEvents','calendarEvents'],['scores','scores'],['leaderboardRewards','leaderboardRewards']].forEach(([collection,key])=>watchCollection(collection,key));
      [['activeWritingSession','scribe'],['activePoll','activePoll'],['dailyAccessOverride','dailyOverride'],['passBlackout','passBlackout'],['main','classMain'],['secondRecess','secondRecess'],['classPet','classPet'],['fieldTrip','fieldTrip'],['universalPoints','universalPoints'],['classJobs','classJobs'],['classSchedule','classSchedule']].forEach(([id,key])=>watchDoc(id,key));
    });
