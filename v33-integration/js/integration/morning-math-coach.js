(function(root){
  ...
  function install(frame){
    ...
    launch.addEventListener('click',()=>{backdrop.classList.add('show');if(!coachFrame.src)coachFrame.src=new URL('../math-operations-quest.html?dw-morning-coach=1',document.baseURI).href});
