...
import {
  ...
  poseAt,
  validateDefinition,
} from "./pet-motion.js?v=dragon-path-7";
import { drawEnemyEffects } from "./enemy-effects.js?v=dragon-path-7";
import { enemyFacing } from "./battle-geometry.js?v=dragon-path-7";
