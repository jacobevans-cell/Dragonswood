...
import {getLessonPractice} from './lesson-practice.js?v=dragon-path-10';
import {PRACTICE_DURATION_RECEIPTS} from './practice-duration-receipts.js?v=dragon-path-10';
