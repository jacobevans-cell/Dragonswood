(function(root){
  ...
  function install(frame){
    ...
    style.textContent='.dw-morning-coach-launch{position:fixed;right:18px;bottom:18px;z-index:10020;display:block;padding:11px 15px;border:2px solid #ffe071;border-radius:999px;background:linear-gradient(135deg,#612aa8,#087c9e);color:#fff;font:900 15px Arial,sans-serif;box-shadow:0 8px 28px #0009;cursor:pointer}body[data-dw-morning-active="1"] .dw-morning-coach-launch{display:block}.dw-morning-coach-backdrop{position:fixed;inset:0;z-index:10030;display:none;grid-template-rows:auto 1fr;padding:10px;background:#020516ed}.dw-morning-coach-backdrop.show{display:grid}.dw-morning-coach-head{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:8px 10px;color:#fff;font:900 14px Arial,sans-serif}.dw-morning-coach-head span{color:#ffe58a}.dw-morning-coach-close{padding:8px 12px;border:1px solid #8ce9ff;border-radius:9px;background:#17204b;color:#fff;font-weight:900}.dw-morning-coach-frame{width:100%;height:100%;border:1px solid #6edfff;border-radius:13px;background:#07102c}@media(max-width:520px){.dw-morning-coach-launch{right:10px;bottom:10px}.dw-morning-coach-backdrop{padding:4px}}';
