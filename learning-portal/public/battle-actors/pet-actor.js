...
import {
  ...
  poseAt,
  validateDefinition,
} from "./pet-motion.js?v=dragon-path-3";
import { drawEnemyEffects } from "./enemy-effects.js?v=dragon-path-3";
import { enemyFacing } from "./battle-geometry.js?v=dragon-path-3";
