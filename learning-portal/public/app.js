...
function nav() {
  return `<a class="nav-link ${route === "home" ? "active" : ""}" href="#home"><span class="nav-icon">◈</span>Curriculum Quest</a><div class="nav-label">DAY ${day} · ${weekday(day).toUpperCase()}</div>${Object.entries(
    ...
    .join(
      "",
    )}<div class="sidebar-note"><strong>One day at a time.</strong><p>Your work stays with you. Come back, reflect, and keep building.</p><span>Monday–Thursday</span></div>`;
}
function shell(body) {
  $("#app").innerHTML =
