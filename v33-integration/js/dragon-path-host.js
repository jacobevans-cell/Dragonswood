(function(){'use strict';
 ...
 function markup(){const url=new URL('../learning-portal/public/embedded.html',document.baseURI);url.searchParams.set('embedded','1');url.searchParams.set('v','dragon-path-15');url.searchParams.set('auth','single-parent-v2');url.hash=route()||'home';return `<section class="unified-dragon-path"><iframe data-dragon-path-frame src="${url.href}" title="Dragon’s Path — daily lessons and adventurer" style="width:100%;min-height:640px;border:0;display:block" scrolling="no"></iframe></section>`;}
