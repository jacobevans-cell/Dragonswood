...
import { actorSelection, trustedActorSelection } from "./battle-actors/actor-selection.js?v=dragon-path-11";
import { mountDailyBattleScene } from "./daily-battle-scene.js?v=dragon-path-11";
import {
  geometryMarkup as geometry,
  coachVisualMarkup as coachVisual,
} from "./daily-battle-visuals.js?v=dragon-path-11";
