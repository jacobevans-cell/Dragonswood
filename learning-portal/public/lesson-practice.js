import { GRADE4_PRACTICE } from './lesson-practice-grade4.js?v=dragon-path-6';
import { GRADE5_PRACTICE } from './lesson-practice-grade5.js?v=dragon-path-6';
import { checkPracticeTask, geometrySVG, geometryExample, PLACE_LABELS, placeValue, placeDigits } from './practice-models.js?v=dragon-path-6';
