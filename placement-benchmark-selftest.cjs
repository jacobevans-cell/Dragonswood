...
assert.equal(data.version,'math-ela-placement-v1');
...
console.log('placement benchmark selftest: PASS (20 Math + 20 ELA / four placement bands / private teacher report)');
