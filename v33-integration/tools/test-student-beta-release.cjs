...
assert.ok(teacher.indexOf('../functions-arcade-access/tester-core.js?v=57.1.16')<teacher.indexOf('js/integration/runtime.js?v=58.1.5'),'teacher root must load the tester contract before runtime');
