...
import { createPetActor } from "./battle-actors/pet-actor.js?v=dragon-path-11";
import { HeroActor } from "./battle-actors/hero-actor.js?v=dragon-path-11";
import { createEnemyActor } from "./battle-actors/enemy-actor.js?v=dragon-path-11";
import {
  prepareSpritePixels,
  recolorSpritePixels,
} from "./battle-actors/sprite-appearance.js?v=dragon-path-11";
import {
  ARENA,
  arenaBackgroundFrame,
  enemyFacing,
} from "./battle-actors/battle-geometry.js?v=dragon-path-11";
