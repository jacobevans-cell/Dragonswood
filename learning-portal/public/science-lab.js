...
} from "./egg-energy.js?v=dragon-path-10";
import { scienceStrategyChooser } from "./science-strategy.js?v=dragon-path-10";
import { lockedVideo } from "./lesson-video.js?v=dragon-path-10";
const esc = (v) =>
  String(v ?? "").replace(
    /[&<>"']/g,
    (c) =>
