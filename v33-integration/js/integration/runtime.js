(function(){
  ...
  async function startTeacher(onUpdate){
    ...
    const unsubs=[];
    const data={roster:[],daily:[],curriculum:[],scribe:{},responses:[],games:[],bathroomRequests:[],snackRequests:[],passRequests:[],pointRequests:[],bathroomStatus:[],snackStatus:[],passStatus:[],passHistory:[],bathroomSlots:[],curriculumOverrides:[],dailyOverride:{},classMain:{},secondRecess:{},classPet:{},fieldTrip:{},universalPoints:{},classJobs:{},jobWeeks:[],classSchedule:{},calendarEvents:[],scores:[],leaderboardRewards:[]};
